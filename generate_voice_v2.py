#!/usr/bin/env python3
"""
generate_voice_v2.py — ElevenLabs TTS builder with auto-resolve of voice NAMES to IDs.

What's new vs v1:
- Accepts in speakers.json either VOICE IDs *or* Voice NAMES (case-insensitive).
...
Usage examples:
  python generate_voice_v2.py voice_script_v1.2_extended.json --api-key $XI_API_KEY --speaker-map speakers.json --srt
...
def main():
    ...
    if not args.json_path:
        raise SystemExit("Provide path to JSON script. Example: voice_script_v1.2_extended.json")
    ...
    print("[OK] Done. Exports in ./output")
