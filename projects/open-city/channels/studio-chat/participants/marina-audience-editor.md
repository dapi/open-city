...
**Именование:** в сценариях, производственных материалах и публичных подводках
используется только полное имя **«Бабка Марина»**. Сокращение «Марина» не используется.
Её личное имя для редкого формального обращения в мире комикса — **Марина Петровна**;
оно не заменяет публичное и рабочее имя.
