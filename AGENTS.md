...
Во всех инструкциях, сценариях, подводках и внутренних материалах персонаж и
сотрудница называется только **Бабка Марина**. Её личное имя для формального
обращения в мире комикса — **Марина Петровна**; оно не заменяет рабочее и
публичное имя «Бабка Марина». Не сокращайте имя до «Марины» и не используйте
другие варианты без явного решения Showrunner.
...
полный состав находится в `~/code/hq/governance/repository-fleet.tsv`, а модель
флота — в `~/code/hq/governance/repository-fleet.md`.
